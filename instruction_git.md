...
* Выполняем команду git push. В случае если в терминале выходит ошибка: The current branch remote has no upstream branch. В данном случае необходимо ввести терминале:
...
* Вносим информацию об предложеных изменениях и нажимаем кнопку Create pull request.